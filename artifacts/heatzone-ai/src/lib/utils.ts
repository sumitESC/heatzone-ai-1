...
export function getHeatZoneColor(zone: string): string {
  switch (zone?.toLowerCase()) {
    case 'cool': return 'text-heat-cool bg-heat-cool/10 border-heat-cool/20';
    case 'moderate': return 'text-heat-moderate bg-heat-moderate/10 border-heat-moderate/20';
